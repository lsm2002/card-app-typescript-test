...
server.post<{ Body: Entry }>("/create/", async (req, reply) => {
  ...
  newEntryBody.scheduled_for
    ? (newEntryBody.scheduled_for = new Date(newEntryBody.scheduled_for))
    : (newEntryBody.scheduled_for = null);
  try {
...
server.put<{ Params: { id: string }; Body: Entry }>("/update/:id", async (req, reply) => {
  ...
  updatedEntryBody.scheduled_for
    ? (updatedEntryBody.scheduled_for = new Date(updatedEntryBody.scheduled_for))
    : (updatedEntryBody.scheduled_for = null);
  try {
